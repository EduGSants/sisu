...
public class Inicio1 extends javax.swing.JFrame {
    ...
    private void atualizarEstatisticasGerais() {
        lblMediaGeralValor.setText(String.format("%.2f", estatisticas.getMediaGeral(listaCursos)));

        String[] categoriasCampus = {"SAO CRISTOVAO", "ARACAJU", "ITABAIANA", "CAMPUS DO SERTAO", "LARANJEIRAS"};
        List<Double> porcCampus = estatisticas.campi(listaCursos);
        ...
        List<Double> porcTurno = estatisticas.turnos(listaCursos);
